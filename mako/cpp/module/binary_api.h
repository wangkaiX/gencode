...
class ${module.service_api_class_name}: public std::enable_shared_from_this<${module.service_api_class_name}>
{
public:
    ${module.service_api_class_name}(boost::asio::io_context &io_context, std::shared_ptr<${connection_class_name}> connection_ptr);
    ~${module.service_api_class_name}();
